...
class Post(models.Model):
    ...
    author = models.ForeignKey(Author, related_name='magazine_post', on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse("magazine:post_detail", args=[self.category.slug, self.slug])
